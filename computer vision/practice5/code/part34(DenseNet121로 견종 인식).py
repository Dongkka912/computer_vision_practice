...
Original file is located at
    https://colab.research.google.com/drive/1lD34fmnlZMaI5wE4pVcA9Tsf20lh7miA
"""
...
# 데이터셋 경로
data_path = '/content/drive/MyDrive/datasets/Stanford_dogs/Images/images'

# 이미지 변환 및 저장할 디렉토리
converted_data_path = '/content/drive/MyDrive/datasets/Stanford_dogs/Images/Images_converted'


#jpg인식 오류로 인해 jpg --> jpeg 변환
...
hist = cnn.fit(train_ds, epochs=30, validation_data=test_ds, verbose=2) # epochs 값 100 > 30 으로 수정
